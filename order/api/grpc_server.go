...
func NewGrpcServer(cfg config.Config, orderService services.OrderService, producer mq.Producer, logger zerolog.Logger) (*grpc.Server, net.Listener, *prometheus.Registry, error) {
